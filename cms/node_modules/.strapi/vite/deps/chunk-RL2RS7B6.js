...
// node_modules/.pnpm/@strapi+review-workflows@5.9.0_av7xrfxy6retdv4djqrtzwpxmm/node_modules/@strapi/review-workflows/dist/_chunks/index-ByXbOW-R.mjs
...
var admin = {
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-BPl2HZMq-PUZMU476.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-DyFV_H0I-VJJHIENJ.js");
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-D9dxziEb-S4LVIM6L.js") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-RL2RS7B6.js.map
