...
var require_browser = __commonJS({
  "node_modules/.pnpm/invariant@2.2.4/node_modules/invariant/browser.js"(exports2, module2) {
    "use strict";
...
var require_capitalize = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/capitalize.js"(exports2, module2) {
    var toString3 = require_toString();
...
var require_camelCase = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/camelCase.js"(exports2, module2) {
...
var require_snakeCase = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/snakeCase.js"(exports2, module2) {
    var createCompounder = require_createCompounder();
...
var require_mapKeys = __commonJS({
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/mapKeys.js"(exports2, module2) {
    var baseAssignValue2 = require_baseAssignValue();
    var baseForOwn = require_baseForOwn();
    var baseIteratee = require_baseIteratee();
...
// node_modules/.pnpm/@strapi+admin@5.9.0_@babel+runtime@7.26.7_@codemirror+autocomplete@6.18.4_@codemirror+languag_aezpjvp2mjsnwk5ooh22wkyeeu/node_modules/@strapi/admin/dist/admin/index-BSJxpmc1.mjs
...
// node_modules/.pnpm/@strapi+admin@5.9.0_@babel+runtime@7.26.7_@codemirror+autocomplete@6.18.4_@codemirror+languag_aezpjvp2mjsnwk5ooh22wkyeeu/node_modules/@strapi/admin/dist/admin/useEnterprise-BGzVPL4w.mjs
...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-BI0D7fJC-U7YUYJYW.js");
      return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-DWol3DVZ-YTKNMIQR.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-pdSopNwV-JODKFRFA.js");
        return {
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-BTE_Cz9k-WCRC36YM.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-Dxi38yo0-FCYEIT24.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-D7Qlkk9D-CS6SJEFE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-CMkC5wC9-KLNKLTVD.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-UHcIKlhQ-NNSYZJAR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-C8ITVaku-4S6KXQ5E.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-D-DXDPnf-XNQJ3WL3.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-Dqo3PXZo-TRBALK3V.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-CJZEJoQP-TTVX2P3B.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-DDML0hej-5T4NQX2G.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-DBC2WBLc-L6UZXQSN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-B8nJeYSW-2MNBSN7T.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-CQO7BSJW-J4H55SGI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-wxPZtkV--EENJ37SJ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-BNaDzPLr-O3HJHULF.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-ByMWzlex-RNV7O6VM.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-BISfAqYE-VCZ5PAI5.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-DjHXN1Tz-BQJ4UJCO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-DGbdGoUi-VNGADBYD.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-DU8CdwGr-FSBGFP7T.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-DNAHJWv5-FL7TBJOC.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-CysC5L5a-3AHOD44O.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-CQG9YVzy-NZZ3ORFT.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-CU7NpjXy-GX5Z4WU7.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-DQ36VXiH-R3ZO4TQD.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-Y3MPY3-0-4DDZ6PFO.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-CGVw08Na-C7XHSZG7.js");
              return {
  ...
  async loadAdminTrads() {
    const adminLocales = await Promise.all(
      this.configurations.locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en-GB.js": () => import("./en-GB-ohKGx5-8-FVQ3OMLK.js") }), `./translations/${locale}.js`, 3);
          return { data, locale };
        } catch {
          try {
            const { default: data } = await __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-B4qxeRNq-PMD5F4T2.js"), "./translations/ca.json": () => import("./ca-CNWrv4Mk-EL7N2NWY.js"), "./translations/cs.json": () => import("./cs-DrRkodPD-HWZ3YRGZ.js"), "./translations/de.json": () => import("./de-D0NA2abW-UJFXQCQA.js"), "./translations/dk.json": () => import("./dk-BhJUQEKK-P6DOJM66.js"), "./translations/en.json": () => import("./en-HhkCMXdW-OKM4TO3V.js"), "./translations/es.json": () => import("./es-YUiY80mn-VRVHNB3F.js"), "./translations/eu.json": () => import("./eu-wKHkhamJ-6NCX2BVC.js"), "./translations/fr.json": () => import("./fr-CQtzdQWu-GON6O6HR.js"), "./translations/gu.json": () => import("./gu-CSS25C49-52W3OJKG.js"), "./translations/he.json": () => import("./he-CR3FKaSH-UWEPBE3S.js"), "./translations/hi.json": () => import("./hi-CRUIUVKR-WOYJSPHB.js"), "./translations/hu.json": () => import("./hu-BqsNBMOK-2ORCA3GA.js"), "./translations/id.json": () => import("./id-cH3Ovozx-KI4D66VT.js"), "./translations/it.json": () => import("./it-D236xPzE-7XSIA6VY.js"), "./translations/ja.json": () => import("./ja-CD7DxKrd-VH6XS2PZ.js"), "./translations/ko.json": () => import("./ko-CgT83B4e-ZQSTXUGJ.js"), "./translations/ml.json": () => import("./ml-BJMvJbX5-UAIV5SEL.js"), "./translations/ms.json": () => import("./ms-eMDSLvhl-HCTJCFEG.js"), "./translations/nl.json": () => import("./nl-CKIw7654-XVJG425U.js"), "./translations/no.json": () => import("./no-D6CAWjEU-J3HOG7T4.js"), "./translations/pl.json": () => import("./pl-jPMrmdJq-I2PHTMGW.js"), "./translations/pt-BR.json": () => import("./pt-BR-THVjG5z2-6WVNRDGK.js"), "./translations/pt.json": () => import("./pt-8dwKSOn3-OIPTGBMI.js"), "./translations/ru.json": () => import("./ru-C34i9wJx-JWYIX74L.js"), "./translations/sa.json": () => import("./sa-B2zR89DH-YHE573L7.js"), "./translations/sk.json": () => import("./sk-DQ2qpsG2-CL3SVZ44.js"), "./translations/sv.json": () => import("./sv-D0vPVUAT-FCFNIPDZ.js"), "./translations/th.json": () => import("./th-BG3IOCqV-PNFH5IAI.js"), "./translations/tr.json": () => import("./tr-BmV7At9f-IDZIGDK6.js"), "./translations/uk.json": () => import("./uk-Ud9QNfkB-27KMSBT4.js"), "./translations/vi.json": () => import("./vi-CGrr4ioy-OKCPNDCJ.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-DrZal35c-3GZLBBO2.js"), "./translations/zh.json": () => import("./zh-DtDdEUIE-SYKAQYTA.js") }), `./translations/${locale}.json`, 3);
            return { data, locale };
          } catch {
...
//# sourceMappingURL=chunk-HH6IMT5T.js.map
